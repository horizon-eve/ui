...
export default {
  create (data, done) {
    return axios.post(`${config.API_BASE_URL}/evesde/crp_npccorporation_research_fields`, data, {
    })
  ...
  update (data, done) {
    return axios.patch(`${config.API_BASE_URL}/evesde/crp_npccorporation_research_fields/${data.id}`, data, {
    })
