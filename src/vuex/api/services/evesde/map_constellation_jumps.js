...
export default {
  create (data, done) {
    return axios.post(`${config.API_BASE_URL}/evesde/map_constellation_jumps`, data, {
    })
  ...
  update (data, done) {
    return axios.patch(`${config.API_BASE_URL}/evesde/map_constellation_jumps/${data.id}`, data, {
    })
