...
export default {
  create (data, done) {
    return axios.post(`${config.API_BASE_URL}/evesde/map_celestial_graphics`, data, {
    })
  ...
  update (data, done) {
    return axios.patch(`${config.API_BASE_URL}/evesde/map_celestial_graphics/${data.id}`, data, {
    })
