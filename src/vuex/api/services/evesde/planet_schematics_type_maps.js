...
export default {
  create (data, done) {
    return axios.post(`${config.API_BASE_URL}/evesde/planet_schematics_type_maps`, data, {
    })
  ...
  update (data, done) {
    return axios.patch(`${config.API_BASE_URL}/evesde/planet_schematics_type_maps/${data.id}`, data, {
    })
