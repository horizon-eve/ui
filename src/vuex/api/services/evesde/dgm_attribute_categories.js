...
export default {
  create (data, done) {
    return axios.post(`${config.API_BASE_URL}/evesde/dgm_attribute_categories`, data, {
    })
  ...
  update (data, done) {
    return axios.patch(`${config.API_BASE_URL}/evesde/dgm_attribute_categories/${data.id}`, data, {
    })
