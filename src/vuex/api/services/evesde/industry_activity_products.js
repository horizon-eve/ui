...
export default {
  create (data, done) {
    return axios.post(`${config.API_BASE_URL}/evesde/industry_activity_products`, data, {
    })
  ...
  update (data, done) {
    return axios.patch(`${config.API_BASE_URL}/evesde/industry_activity_products/${data.id}`, data, {
    })
