...
let API_BASE_URL, AUTH_BASE_URL, ESI_BASE_URL
...
switch (process.env.NODE_ENV) {
  ...
  case 'production':
    ...
    ESI_BASE_URL = 'https://esi.racopub.com'
    break
  default: throw new Error(`Which environment? ${process.env.NODE_ENV}`)
}
